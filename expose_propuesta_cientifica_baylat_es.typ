...
El presente proyecto de investigación bilateral entre la Technische Hochschule Deggendorf (DIT, Baviera) y la Universidad de Cartagena (UdC, Colombia) plantea el desarrollo de un marco analítico y computacional para la predicción del deterioro fitoquímico y la pérdida de frescura en café especial colombiano (*Coffea arabica*). Con una asignación semilla de 12 meses financiada por BAYLAT (7.350 €), la investigación aborda las variaciones de calidad que experimenta el grano durante el almacenamiento poscosecha en ambientes tropicales cálido-húmedos y el transporte marítimo hacia Europa (20 a 45 días), con destino a mercados como el bávaro. Durante este periodo, la autoxidación lipídica y la hidrólisis de los ácidos clorogénicos modifican los atributos sensoriales y fitoquímicos del grano verde. Frente a los tiempos y costos de los análisis cromatográficos convencionales y la naturaleza cualitativa de la catación organoléptica, el proyecto propone un enfoque metodológico integrado: (1) el monitoreo longitudinal en condiciones ambientales reales de almacenamiento en el Caribe colombiano, mediante espectroscopía en infrarrojo medio con reflectancia total atenuada (ATR-FTIR) y ensayos fisicoquímicos normalizados (AOAC/ISO); y (2) modelos de Deep Learning informados por la física (Physics-Informed Neural Networks - PINN), que incorporan cinéticas de degradación de tipo Arrhenius para complementar la quimiometría lineal (PLSR) y aportar interpretabilidad físico-química a las predicciones. La cooperación bilateral se articula mediante un workshop presencial en Cartagena y una estancia de investigación de 2 semanas en el Campus de IA de Deggendorf, generando los datos piloto necesarios para postular a la convocatoria bilateral DFG-Minciencias.
...
Dentro de esta estructura productiva, el segmento de los cafés especiales (*Specialty Coffee*), formalmente delimitado por los estándares de la Specialty Coffee Association @sca2020specialtycoffee, ha cobrado una creciente relevancia económica. La SCA define como café especial aquel lote trazable que obtiene una calificación de taza igual o superior a 85 puntos en una escala sobre 100, evaluada mediante un protocolo estandarizado de diez descriptores sensoriales (fragancia/aroma, sabor, sabor residual, acidez, cuerpo, balance, uniformidad, taza limpia, dulzor y puntaje general). Estos cafés, caracterizados por notas florales y frutales y perfiles de acidez específicos, acceden a primas de precio en los mercados de especialidad europeos. En este escenario, el Estado Libre de Baviera y la República Federal de Alemania representan uno de los mercados de mayor demanda de cafés diferenciados de origen, donde tostadores y consumidores valoran la consistencia de la calidad en taza @sca2020specialtycoffee.

== 2.2 Condiciones de Almacenamiento Tropical y Transporte Marítimo Transatlántico
La preservación del perfil de taza y de la calidad química del café especial en grano verde (*green coffee*) depende estrechamente de las condiciones ambientales a lo largo de la cadena poscosecha. En Colombia, el almacenamiento en fincas, cooperativas y bodegas de acopio en la costa Caribe (p. ej., Cartagena de Indias o Santa Marta) se realiza habitualmente bajo condiciones ambientales cálido-húmedas, con temperaturas que oscilan entre 25 °C y 38 °C y humedades relativas entre 60% y 85% RH.

Durante el transporte marítimo transatlántico hacia puertos europeos (habitualmente de 20 a 45 días), los contenedores de carga están expuestos a variaciones térmicas circadianas y condensación interna. Estas condiciones favorecen reacciones de envejecimiento químico (*staling*), decoloración del grano verde y degradación de los precursores químicos del aroma y sabor, lo que puede incidir negativamente en la calificación sensorial SCA obtenida inicialmente en el origen.

== 2.3 Vías Fitoquímicas de Degradación y Marcadores Moleculares de Calidad
A escala molecular, las alteraciones de *Coffea arabica* durante el almacenamiento prolongado corresponden a tres procesos fitoquímicos principales:

1. *Hidrólisis y transformación de ácidos clorogénicos (CGA):* Los ácidos clorogénicos representan entre el 6% y el 9% de la materia seca del café arábica y comprenden ésteres cafeoilquínicos (5-CQA, 3-CQA, 4-CQA), dicafeoilquínicos y feruloilquínicos @farah2012coffeeconstituents. El 5-CQA, analito mayoritario, es el principal determinante de la acidez fina y del potencial antioxidante del grano. Durante el almacenamiento a temperaturas elevadas, los enlaces éster experimentan una hidrólisis progresiva que libera ácido quínico y ácido cafeico libre, o bien lactonizan formando quinidas @farah2012coffeeconstituents. Esta alteración modifica el balance ácido del grano, incidiendo en la acidez titulable evaluada según el método oficial AOAC 920.92 @aoac92092 y generando sabores amargos y astringentes.

2. *Peroxidación radicalaria de la fracción lipídica:* La fracción lipídica constituye del 12% al 17% del peso seco del grano y está integrada primordialmente por triacilgliceroles con alto contenido de ácido linoleico ($"C18:2"$) y ésteres diterpénicos (cafestol y kahweol). Por acción del oxígeno atmosférico y la temperatura, los ácidos grasos insaturados experimentan reacciones de autoxidación lipídica @buffo2004coffeevolatiles. En este proceso se forman hidroperóxidos lipídicos, cuantificables mediante el índice de peróxidos conforme a la norma AOAC 965.33 @aoac96533. La descomposición secundaria de estos intermediarios genera compuestos carbonílicos volátiles de bajo peso molecular (hexanal, trans-2-nonenal, octanal), asociados a descriptores de pérdida de frescura, notas a madera seca o defectos de añejamiento (*baggy*) @buffo2004coffeevolatiles.

3. *Variación higroscópica y actividad de agua ($a_w$):* Tras el secado poscosecha, el café en grano verde se almacena normalmente con un contenido de humedad del 10% al 12% en base húmeda (normas oficiales AOAC 968.11 @aoac96811 e ISO 6673 @iso6673), correspondiente a una actividad de agua ($a_w$) en equilibrio de aproximadamente 0,50 a 0,60. En condiciones de alta humedad relativa ambiental ($> 70\%$) y temperaturas cálidas ($> 25 thin degree"C"$), el grano absorbe vapor de agua de la atmósfera circundante. Al superar valores de $a_w > 0,65$, la mayor movilidad del agua en la estructura celular favorece la reactividad química —incluyendo la hidrólisis de ésteres clorogénicos y lípidos— e incrementa el riesgo de proliferación fúngica y defectos sensoriales, reduciendo la estabilidad del lote durante el almacenamiento prolongado.

== 2.4 Limitaciones de los Ensayos Convencionales y Oportunidades de la Espectroscopía ATR-FTIR
El control de calidad en las etapas de almacenamiento y comercialización presenta desafíos analíticos con los métodos actualmente disponibles:
- Por un lado, la *catación sensorial SCA* @sca2020specialtycoffee constituye una metodología cualitativa orientada a la evaluación organoléptica final. Requiere paneles de catadores entrenados y detecta las alteraciones únicamente cuando los cambios de sabor y aroma ya han ocurrido, sin aportar una estimación cuantitativa directa de la evolución química residual de un lote.
- Por otro lado, las *metodologías analíticas instrumentales clásicas*, como la cromatografía líquida de alta resolución (HPLC) y la cromatografía de gases acoplada a espectrometría de masas (GC-MS), ofrecen una elevada resolución química, pero son técnicas destructivas, requieren tiempos prolongados de preparación de muestra y conllevan costos analíticos considerables ($150 - 300 thin "USD"$ por muestra), lo que limita su aplicación sistemática en centros de acopio o terminales de embarque.

Frente a estas limitaciones, la *espectroscopía infrarroja media con reflectancia total atenuada (ATR-FTIR)* constituye una alternativa rápida y no destructiva @manzocco2020shelf. La técnica ATR-FTIR permite obtener el perfil vibracional directo de muestras de café molido en pocos minutos, sin consumo intensivo de reactivos y con adecuada reproducibilidad instrumental. El espectro obtenido en la región del infrarrojo medio ($4000 - 600 thin "cm"^(-1)$) actúa como una huella molecular integral que captura simultáneamente las transiciones vibracionales asociadas a los enlaces fitoquímicos clave del café: la banda de estiramiento éster $nu("C=O")$ en $1745 thin "cm"^(-1)$ y el hombro de ácidos libres en $1715 thin "cm"^(-1)$, el doble enlace $nu(= "C-H")$ _cis_ en $3008 thin "cm"^(-1)$, la tensión de fenoles y agua en $3400 - 3250 thin "cm"^(-1)$, y los estiramientos de ésteres de ácidos clorogénicos en $1380 - 1150 thin "cm"^(-1)$. No obstante, la complejidad de las firmas espectrales ATR-FTIR —caracterizadas por superposición de bandas, dispersión física y efectos de matriz— requiere modelos computacionales calibrados capaces de extraer correlaciones cinéticas causales y generalizar de forma robusta @manzocco2020shelf.
...
Desarrollar y validar experimentalmente un marco analítico y computacional de monitoreo no destructivo basado en espectroscopía infrarroja media (ATR-FTIR), determinaciones fisicoquímicas normalizadas (AOAC/ISO) y modelos de Deep Learning informados por la física (PINN), para estimar marcadores moleculares y predecir las trayectorias cinéticas de degradación y pérdida de frescura en lotes de café especial colombiano (*Coffea arabica*) almacenados bajo condiciones ambientales tropicales.

== 3.3 Objetivos Específicos
1. *Alineado con WP1 (Puesta a punto experimental, recolección y Workshop en Cartagena):* Estandarizar el diseño experimental longitudinal y el protocolo analítico de adquisición espectral rápida ATR-FTIR sobre lotes de café especial (*Coffea arabica* cultivares *Castillo*, *Caturra*, *Colombia* y *Geisha*), asegurando la calibración instrumental y realizando un workshop presencial bilateral de capacitación en Inteligencia Artificial aplicada a la espectroscopía agroalimentaria en la Universidad de Cartagena, impartido por la investigadora principal del DIT para docentes y jóvenes investigadores de la UdC.
...
- *Alcaloides:* La cafeína (1,3,7-trimetilxantina, $1,0 - 1,4\%$ p/p) exhibe alta estabilidad térmica frente a la oxidación atmosférica en condiciones estándar; en contraste, la trigonelina ($N$-metilbetaina del ácido nicotínico, $0,8 - 1,2\%$ p/p) opera como osmolito celular y regulador metabólico, constituyendo un precursor termolábil de compuestos aromáticos volátiles como piridinas y pirazinas.
- *Carbohidratos y Fracción Nitrogenada:* La sacarosa ($6 - 9\%$ p/p) representa el carbohidrato soluble libre dominante, susceptible a hidrólisis ácida o enzimática. Los polisacáridos estructurales insolubles ($45 - 50\%$ de la materia seca) están formados por complejos de galactomananos y arabinogalactanos ramificados que constituyen la pared celular vegetal. Las proteínas ($10 - 13\%$) abarcan globulinas de reserva (alelo-globulinas 11S) y una fracción de péptidos y aminoácidos libres (asparagina, ácido glutámico).

Durante el acopio, manipulación poscosecha y transporte transatlántico en climas cálidos y húmedos propios de las zonas tropicales colombianas, el café experimenta dos vías principales de alteración fisicoquímica (@buffo2004coffeevolatiles, @ribeiro2011chemicalchanges):
1. *Hidrólisis e isomerización de ácidos clorogénicos:* Por acción de la humedad y la temperatura ambiental, el enlace éster entre el ácido quínico y los ácidos hidroxicinámicos sufre hidrólisis progresiva. Esta ruptura libera ácido quínico libre y ácido cafeico libre, alterando el pH del grano e incrementando la acidez titulable total mediante un perfil astringente y acre. De forma paralela, la autooxidación de los anillos orto-difenólicos del ácido cafeico genera quinonas que reaccionan con aminoácidos libres, favoreciendo el pardeamiento residual y la pérdida de coloración verde.
2. *Rancidez lipídica y biogénesis de volátiles degradativos:* La fracción insaturada de los lípidos (particularmente el ácido linoleico, con carbonos metilénicos bis-alílicos $-"CH"="CH"-"CH"_2-"CH"="CH"-$, de menor energía de disociación de enlace $"C-H"$) es susceptible a la autoxidación en presencia de oxígeno. La iniciación y propagación generan hidroperóxidos lipídicos (ROOH), cuantificables a través del índice de peróxidos. Estos hidroperóxidos sufren posterior escisión secundaria ($beta$-scission), produciendo aldehídos volátiles alifáticos (hexanal, nonanal, octanal, trans-2-nonenal), cetonas y ácidos grasos libres de cadena corta. La acumulación de estos compuestos se asocia a la pérdida de frescura, afectando los atributos florales y frutales característicos de los cafés de especialidad con notas a madera seca y defectos de almacenamiento (*staling*).
...
A pesar de su utilidad práctica en análisis estáticos, la quimiometría lineal presenta tres limitaciones para el monitoreo dinámico:
...
=== 5.1.3 Monitoreo Continuo con Dataloggers Multiparamétricos
El seguimiento ambiental en las áreas de almacenamiento se efectúa de manera continua mediante una red de dataloggers multiparamétricos digitales calibrados (precisión de $plus.minus 0,3 thin degree"C"$ en temperatura y $plus.minus 2,0\%$ en humedad relativa). Los sensores se distribuyen en el espacio de la bodega y en el interior y superficie de los sacos de café, registrando a intervalos de 15 minutos:
1. *Temperatura ambiental ($T$):* Registro térmico continuo expresado en grados Celsius ($degree"C"$) y Kelvin ($"K"$).
2. *Humedad relativa del aire ($"HR"$):* Medición de la humedad relativa ambiental expresada en porcentaje ($"%"$).
3. *Temperatura de punto de rocío ($T_("rocío")$ o $T_("dew")$):* Parámetro psicrométrico para detectar condiciones propensas a microcondensación superficial durante oscilaciones térmicas nocturnas.
...
- *Actividad 3.4 (Meses 9–11): Validación cruzada agrupada e interpretabilidad explicable (XAI):* Protocolo de validación *Leave-One-Batch-Out* (GroupKFold) para descartar fuga de información inter-lote. Mapeo de atribución espectral (Grad-CAM e Integrated Gradients) verificando que las activaciones de la red converjan en las frecuencias diagnósticas del café ($1745, 1715, 1600 - 1650 thin "cm"^(-1)$).
#callout(title: "Hito H3 (Mes 9)")[
  *Arquitectura híbrida óptima seleccionada mediante análisis multicriterio (precisión RMSE/$R^2$, fidelidad fisicoquímica y explicabilidad XAI), consistencia espectral validada y estancia de la Misión 2 concluida exitosamente.*
]
...
#table(
  ...
  [3.4 Validación Leave-One-Batch e Interpretabilidad XAI], [DIT/UdC], [], [], [], [], [], [], [], [], [x], [x], [x], [], [*H3 (Mes 9)*],
...
- *Technische Hochschule Deggendorf (DIT, Alemania) — Liderazgo en IA Aplicada y Supercómputo:* A través del Campus de IA y la Facultad de Informática Aplicada, bajo la dirección de la Prof. Dr. Isabel Suárez, la DIT es un centro de referencia en Baviera para la investigación algorítmica aplicada. La DIT aporta clústeres de cómputo con GPUs para deep learning, experiencia en el desarrollo de redes neuronales informadas por principios físicos (PINN), modelos de espacio de estados para series temporales (Mamba SSM) y técnicas de explicabilidad algorítmica (XAI) para espectroscopía agroalimentaria.
